    ...
    <section id="portfolio">
      ...
      <form action="proses_registrasi.php" class="col-12 text-center" method="post" id="form">
        <div class="form-group">
          <input type="text" class="btn js-scroll-trigger" id="nama" placeholder="Nama" name="nama" value="<?php if(isset($av)){echo $av['nama'];} ?>" required maxlength="40">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          <div class="form-check-inline">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" name="jk" value="L" <?php if(isset($av)){if($av['jk'] == 'L'){echo 'checked';}} ?> required>Laki-Laki
            </label>
          </div>
          <div class="form-check-inline">
            <label class="form-check-label">
              <input type="radio" class="form-check-input" name="jk" value="P" <?php if(isset($av)){if($av['jk'] == 'P'){echo 'checked';}} ?>>Perempuan
            </label>
          </div>
        </div>
        <div class="form-group">
